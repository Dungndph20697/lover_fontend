...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const userInfo = await apiUserService.getCurrentUser();

    if (result.success) {
      if (userInfo.user.role.name === "User") {
        navigate("/companion");
      }
      if (userInfo.user.role.name === "Service_provider") {
        navigate("/dashboard");
      }
    } else {
            ...
            <div className="glass-card p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center mt-4">
                  ...
                  <a
                    href="/register"
                    className="text-purple fw-medium text-decoration-none"
                  >
                    Đăng ký ngay
                  </a>
                </div>
