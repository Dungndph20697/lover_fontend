...
export default function DashboardCCDV() {
            ...
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <div className="space-y-2 text-left bg-gray-100 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-gray-500">Auth loading: {loading ? 'Yes' : 'No'}</p>
                        <p className="text-sm text-gray-500">Data loading: {loadingData ? 'Yes' : 'No'}</p>
                        <p className="text-sm text-gray-500">User: {user ? `${user.nickname || user.first_name} (${user.role})` : 'None'}</p>
                        <p className="text-sm text-gray-500">isProvider: {isProvider ? 'Yes' : 'No'}</p>
                        <p className="text-sm text-gray-500">isUser: {isUser ? 'Yes' : 'No'}</p>
                        <p className="text-sm text-gray-500">isAuthenticated: {isAuthenticated ? 'Yes' : 'No'}</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <div className="space-y-2 text-left bg-red-50 p-4 rounded-lg border border-red-200">
                        ...
                        <p className="text-sm text-gray-500">User: {user ? `${user.nickname || user.first_name} (${user.role})` : 'None'}</p>
                        <p className="text-sm text-gray-500">Profile Data: {profileData ? 'Available' : 'Missing'}</p>
                        <p className="text-sm text-gray-500">Data Loading: {loadingData ? 'In Progress' : 'Completed'}</p>
                        <p className="text-sm text-gray-500">isProvider: {isProvider ? 'Yes' : 'No'}</p>
                        <p className="text-sm text-gray-500">isAuthenticated: {isAuthenticated ? 'Yes' : 'No'}</p>
                    </div>
            ...
            <div className="min-h-screen bg-gray-50 py-8">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h2 className="text-2xl font-semibold text-gray-900 mb-6">Dashboard Người dùng</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-purple-50 p-4 rounded-lg">
                                <h3 className="text-lg font-semibold text-purple-900 mb-2">Dịch vụ đã sử dụng</h3>
                                <p className="text-3xl font-bold text-purple-600">0</p>
                                <p className="text-purple-700 text-sm mt-1">Lần sử dụng dịch vụ</p>
                            </div>
                            <div className="bg-pink-50 p-4 rounded-lg">
                                <h3 className="text-lg font-semibold text-pink-900 mb-2">Yêu thích</h3>
                                <p className="text-3xl font-bold text-pink-600">0</p>
                                <p className="text-pink-700 text-sm mt-1">Dịch vụ yêu thích</p>
                            </div>
                            <div className="bg-indigo-50 p-4 rounded-lg">
                                <h3 className="text-lg font-semibold text-indigo-900 mb-2">Đánh giá</h3>
    ...
    return (
        <div className={`min-h-screen ${darkMode ? "bg-gray-900" : "bg-gradient-to-br from-purple-50 to-pink-50"} transition-colors`}>
            {/* Header */}
            <header className={`bg-white shadow-sm border-b ${darkMode ? "bg-gray-800 border-gray-700" : "border-gray-200"}`}>
            ...
            <section className="relative py-8">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    {/* Profile Info */}
                    <div className={`p-8 rounded-2xl backdrop-blur-lg ${darkMode ? "bg-gray-800/50 border border-gray-700" : "bg-white/70 border border-gray-200"} shadow-xl`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <div>
                                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Tổng booking</p>
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <div>
                                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Tổng thu nhập</p>
                                    <p className={`text-2xl font-bold ${darkMode ? "text-white" : "text-gray-900"}`}>
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <div>
                                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Booking tháng này</p>
                                    <p className={`text-2xl font-bold ${darkMode ? "text-white" : "text-gray-900"}`}>
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <div>
                                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Đánh giá TB</p>
                                    <p className={`text-2xl font-bold ${darkMode ? "text-white" : "text-gray-900"}`}>
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-2">
                                ...
                                <div>
                                    <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Lượt xem hồ sơ</p>
                                    <p className={`text-2xl font-bold ${darkMode ? "text-white" : "text-gray-900"}`}>
